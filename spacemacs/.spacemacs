...
before packages are loaded."
  ...
  (fset 'tran2
        (kmacro-lambda-form [?i ?\C-r ?a escape ?l ?\" ?w ?y ?t ?\" ?\C-w ?\C-w ?o ?\C-r ?w ?: ?  ?\C-r ?w escape ?\C-w ?\C-w ?\C-s ?\{ ?\{ ?t ?  ?\" return] 0 "%d"))
  (fset 'tran
        (kmacro-lambda-form [?\" ?w ?d ?i ?\{ ?\{ ?t ?  ?\" ?\C-r ?\" ?\} ?\} escape] 0 "%d"))
  (fset 'tran-all
        (kmacro-lambda-form [?\" ?w ?d ?i ?\{ ?\{ ?t ?  ?\" escape ?\" ?a ?p ?a ?. ?\C-r ?w ?\" ?\} ?\} escape ?\C-w ?\C-w ?o ?\C-r ?w ?: ?  ?\C-r ?w escape ?\C-w ?\C-w] 0 "%d"))
